...
struct TextRenderingSnapshotTests {
    ...
    func basicText() throws {
        ...
        let image = try #require(SnapshotTestUtilities.captureFrame(renderer: renderer) { r in
            r.drawText("Hello World", position: Vector2(x: 10, y: 10),
    ...
    func textSizes() throws {
        ...
        renderer.setBackgroundColor(Color(r: 0, g: 0, b: 0))
        let image = try #require(SnapshotTestUtilities.captureFrame(renderer: renderer) { r in
            r.drawText("Size 10", position: Vector2(x: 10, y: 10),
                       font: font, size: 10, color: .white)
            r.drawText("Size 16", position: Vector2(x: 10, y: 40),
                       font: font, size: 16, color: .white)
            r.drawText("Size 24", position: Vector2(x: 10, y: 80),
                       font: font, size: 24, color: .white)
            r.drawText("Size 32", position: Vector2(x: 10, y: 130),
                       font: font, size: 32, color: .white)
        })
    ...
    func textColors() throws {
        ...
        renderer.setBackgroundColor(Color(r: 0, g: 0, b: 0))
        let image = try #require(SnapshotTestUtilities.captureFrame(renderer: renderer) { r in
            r.drawText("Red", position: Vector2(x: 10, y: 30),
                       font: font, size: 24, color: Color(r: 255, g: 0, b: 0))
            r.drawText("Green", position: Vector2(x: 10, y: 80),
                       font: font, size: 24, color: Color(r: 0, g: 255, b: 0))
            r.drawText("Blue", position: Vector2(x: 10, y: 130),
                       font: font, size: 24, color: Color(r: 0, g: 0, b: 255))
        })
    ...
    func textMeasuredBox() throws {
        ...
        let image = try #require(SnapshotTestUtilities.captureFrame(renderer: renderer) { r in
            ...
            r.drawText(text,
                       ...
                       font: font, size: fontSize, color: .white)
        })
    ...
    func specialCharacters() throws {
        ...
        renderer.setBackgroundColor(Color(r: 0, g: 0, b: 0))
        let image = try #require(SnapshotTestUtilities.captureFrame(renderer: renderer) { r in
            r.drawText("Score: 9999!@#$",
                       position: Vector2(x: 10, y: 40),
                       font: font, size: 20, color: .white)
            r.drawText("HP: 100/100 [OK]",
                       position: Vector2(x: 10, y: 80),
                       font: font, size: 20, color: .white)
            r.drawText("Time: 12:34.56",
