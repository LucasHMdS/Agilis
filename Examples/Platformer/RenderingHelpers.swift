...
func drawPlayer(
    ...
    let sprite = makeSprite(
        ...
        source: atlas.rect(rectName),
        pos: pos,
        destWidth: Mario.playerWidth,
        destHeight: Mario.playerHeight,
...
func drawTile(
    ...
    case .pipeTop:
        ...
        let leftSprite = makeSprite(
            texture: atlas.texture,
            source: atlas.rect("pipe_top_left"),
        ...
        let rightSprite = makeSprite(
            texture: atlas.texture,
            source: atlas.rect("pipe_top_right"),
            pos: Vector2(x: pos.x + halfW / 2, y: pos.y),
            destWidth: halfW,
            destHeight: s
        )
    ...
    case .pipeBody:
        let leftSprite = makeSprite(
            texture: atlas.texture,
            source: atlas.rect("pipe_body_left"),
        ...
        let rightSprite = makeSprite(
            texture: atlas.texture,
            source: atlas.rect("pipe_body_right"),
            pos: Vector2(x: pos.x + s / 4, y: pos.y),
            destWidth: s / 2,
            destHeight: s
        )
...
func drawGoomba(
    ...
    if enemy.isDead {
        let sprite = makeSprite(
            texture: atlas.texture,
            source: atlas.rect("goomba_squished"),
            pos: Vector2(x: pos.x, y: pos.y + Mario.goombaHeight / 2 - 4),
            destWidth: Mario.goombaWidth,
            destHeight: 8
        )
        renderer.drawSprite(sprite)
        return
