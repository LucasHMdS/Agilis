...
public class UIModalDialog: UINode, @unchecked Sendable {
    ...
    internal func renderModal(renderer: any RenderBackend, theme: UITheme, screenSize: Size) {
        // Dim overlay
    ...
    private func measureAllText(in node: UINode, renderer: any RenderBackend, font: FontHandle) {
