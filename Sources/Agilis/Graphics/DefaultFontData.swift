/// Embedded ProggyClean TTF font (~41KB, MIT license).
/// From: https://github.com/ocornut/imgui/blob/master/misc/fonts/ProggyClean.ttf
enum DefaultFontData {
    static let ttfBytes: [UInt8] = [
